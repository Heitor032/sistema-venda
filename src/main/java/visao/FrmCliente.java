...
public class FrmCliente extends javax.swing.JFrame {
    ...
    ModeloCliente modBairro = new ModeloCliente();
    ControleCliente control = new ControleCliente();
    ControleTelefone connTel = new ControleTelefone();
    ...
    public FrmCliente() {
        ...
        preecherTabela(" select \n"
                ...
                + ";");
        connBairro.executaSQL("select * from TB_cidade,tb_bairro order by nome_cidade,nome_bairro");
        connTel.executaSQL("select * from Tb_telefone order by numero_tel");
        MaskFormatter frm = new MaskFormatter("(##)#### - ####");
        jComboBoxTel.String(new DefaultFormatterFactory(frm));
        ...
        try {
            connex.rs.first();
            do {
                jComboBoxCidade.addItem(connex.rs.getString("nome_cidade"));
                jComboBoxBairro.addItem(connex.rs.getString("nome_bairro"));
                jComboBoxTel.addItem(connex.rs.getString("numero_tel"));
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    private void initComponents() {
        ...
        jComboBoxTel.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxTelActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(jFormattedTextFieldRG, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void jComboBoxTelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxTelActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jComboBoxTelActionPerformed

    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        // TODO add your handling code here:
        // String nomeCliente = jTextFieldNome.setText();
